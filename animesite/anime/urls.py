...
urlpatterns = [
    ...
    path('anime/addanime/', views.AddNewAnimeView.as_view(), name='add_new_anime'),
    path('anime/addgenre/', views.AddNewGenreView.as_view(), name='add_new_genre'),
    path('anime/addyear/', views.AddNewYearView.as_view(), name='add_new_year'),
    path('anime/addproducer/', views.AddNewProducerView.as_view(), name='add_new_producer'),
