...
SECRET_KEY = 'django-insecure-%vosr=^9*yx7#ayd-xfvyt7!m3cocp^1p1il3+=gxya-lnuznu'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'users.context_processors.get_anime_context',
            ],
        },
    },
]
...
EMAIL_HOST_PASSWORD = 'wzsqqittgnzvhnfo'
EMAIL_USE_SSL = True
